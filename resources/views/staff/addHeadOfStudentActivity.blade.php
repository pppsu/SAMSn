...
<section>
    <div >
        <div class="row">
            <h3>Add Head of Student Activity Section Information</h3>
        </div>      
    </div>
</section>
<section>
    <div class="row">
        <div class="col s12 m12 l12">
            ...
            @if ( count($errors) > 0 )
                ...
                @endif
                <form method="POST" action="addHeadOfStudentActivity">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s12 l3 m3 ">
                            <input type="text" id="psu_passport" class="validate" name="id" value="19940001">
