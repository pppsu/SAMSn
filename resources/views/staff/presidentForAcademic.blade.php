	...
	<table class="striped">	
		<thead>
			...
			<tr class="jsgrid-alt-row">
				...
				<td>{{ $s->email }}</td>
				<td>
					<a href="editPresidentForAcademic_{{$s->id}}"><i class="Tiny material-icons ">mode_edit</i></a>
					<a href="presidentForAcademic/delete/{{$s->id}}"><i class="Tiny material-icons " style="color: red">delete</i></a>
				</td>
			</tr>
			@endforeach
		</tbody>
