	...
	<div class="row">
		<div class="col s12 m12 l12">
			<div class="card-panel">
				<form method="POST" action="studentCouncil/update/{{ $student->id }}">
					...
					<div class="row">
						<div class="input-field col s12 l3 m3 ">
							...
							<label for="psu_passport">PSUPassport</label>          
						</div>
					</div>	
					<div class="row">
						<div class="input-field col s12 l3 m3">
					...
					<div class="row">
						<div class="input-field  col s12 l6 m6">
							...
							<input type="text" id="begin" placeholder="Begin Date" name="begin_date" value="{{ $student->begin_date }}">
							<label for="begin">Begin Date</label>
						</div>
						<div class="input-field  col s12 l6 m6">
							<!-- <input type="date" class="datepicker" id="end" placeholder="End Date" name="end_date"> -->
							<input type="text" id="end" placeholder="End Date" name="end_date" value="{{ $student->end_date }}">
