...
<section>
    <div >
        <div class="row">
            <h3>Add Information Assistant to the President for Student Development</h3>
        </div>      
    </div>
</section>
<section>
    <div class="row">
        <div class="col s12 m12 l12">
            ...
            @if ( count($errors) > 0 )
                ...
                @endif
                <form method="POST" action="addPresidentForStudent">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s12 l3 m3 ">
                            <input value="2017003" id="disabled" type="text" class="validate" name="id">
